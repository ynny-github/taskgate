...
| 0002 | [Directory description filename](0002-directory-description-filename.md) | Superseded by ADR-0004 |
| 0003 | [AI output wire format](0003-ai-output-wire-format.md) | Accepted |
| 0004 | [Recursive no-argument browse and executable-only listing](0004-recursive-browse-and-executable-filter.md) | Accepted |
| 0005 | [Task dependency lifecycle (before/after)](0005-task-dependency-lifecycle.md) | Accepted |
| 0006 | [Task CLI parser (args/flags declaration)](0006-task-cli-parser.md) | Accepted |
